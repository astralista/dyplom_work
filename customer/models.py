...
class User(AbstractUser):
    ...
    company = models.CharField(
        verbose_name="Компания", max_length=40, blank=True, null=True
    )
    position = models.CharField(
        verbose_name="Должность", max_length=40, blank=True, null=True
    )
...
class Contact(models.Model):
    ...
    work_phone = models.CharField(
        max_length=40, verbose_name="Рабочий телефон", blank=True
    )
